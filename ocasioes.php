<?php 
    ...
    if (!isset($_GET['ocasiao'])){
        header("Location: ocasioes.php?ocasiao=Romantica");
    }
...
<div class="container">
    ...
    $query4 = "SELECT * FROM ocasioes WHERE Ocasiao = '$ocasiao'";
    $result4 = mysqli_query($conn, $query4);

    while ($row4 = mysqli_fetch_assoc($result4)){
       echo "<div class='card'>
                <img src='" . htmlspecialchars($row4['Img']) . "' alt='" . htmlspecialchars($row4['Nome']) ."' class='card-image'>
                <div class='content'>
                    <div class='titulo'>
                        <h2>" . htmlspecialchars($row4['Nome']) ."</h2>
                    </div>
                    <div class='card-content'>
                        <p>". htmlspecialchars($row4['Descricao'])."</p>
